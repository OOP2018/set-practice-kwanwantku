...
public class SetPractice {
	...
	public static void setExplorer( ) {
		...
		// It's not same order.It's tell about when you print by using iterator. 
		//There manage contain in set to sort order from A-Z.
		...
		TreeSet<String> treesets = new TreeSet<String>(new Comparator<String>() {
			@Override
